...
public class OrderService {
    ...
    public Orders updateOrder(Integer orderId, OrderRequestDto orderRequestDto) {
        Optional<Orders> orders = ordersRepository.findById(String.valueOf(orderId));
        if (orders.isPresent()) {
            Orders existingOrder = orders.get();
    ...
    public void deleteOrder(Integer orderId) {
        ordersRepository.deleteById(String.valueOf(orderId));
    }
}
