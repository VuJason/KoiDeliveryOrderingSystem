...
function MapComponent() {
    ...
    const fetchSuggestions = async (input) => {
      const apiKey = "AlzaSyixHNfkSAsqW2EkDIdLFbwzm2FtB4PtRJj";
      try {
        const response = await fetch(
          `https://maps.gomaps.pro/maps/api/place/queryautocomplete/json?input=${encodeURIComponent(input)}&offset=3&location=10.8231,106.6297&radius=1000&language=vi&key=${apiKey}`
        );
